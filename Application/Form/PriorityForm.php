...
use Application\Validator\PriorityValidator;
use Application\Filter\PriorityFilter;
 ...
 *
 */
class PriorityForm extends BaseForm{
    ...
    {
        parent::init();
        $this->validator = new PriorityValidator();
