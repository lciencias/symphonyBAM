 ...
 */
class ImpactLog extends AbstractBean{

    /**
     * TABLENAME
     */
    const TABLENAME = 'pcs_symphony_impact_logs';

    /**
     * Constants Fields
     */
    const ID_IMPACT_LOG = 'id_impact_log';
     ...
     * @return int
     */
    public function getIdImpactLog(){
        return $this->idImpactLog;
    }
     ...
     * @return ImpactLog
     */
    public function setIdImpactLog($idImpactLog){
        $this->idImpactLog = $idImpactLog;
        return $this;
    }
    ...
    {
        $array = array(
            'id_impact_log' => $this->getIdImpactLog(),
