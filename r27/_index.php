...
foreach ($reporte as $key => $value) {
	...
	$datos = "SELECT id_ticket_client, MAX(FechaOperacion) FechaOperacion, MAX(HoraOperacion) HoraOperacion, MAX(Ubicacion) Ubicacion, MAX(Adquiriente)Adquiriente, MAX(Monto)Monto
				FROM (
				  SELECT
					id_ticket_client,
				    CASE WHEN id_field = 2 THEN value END AS 'FechaOperacion',
