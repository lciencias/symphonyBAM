    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="3">
                    {$i18n->_('From')}: <input type="text" name="register_start_date" id="register_start_date" value="{$post['register_start_date']}" class="datetimepicker span4" />
                    {$i18n->_('To')}: <input type="text" name="register_end_date" id="register_end_date" value="{$post['register_end_date']}" class="datetimepicker span4" />
                </td>
                <td>{$i18n->_('Activity Date')}</td>
                <td colspan="3">
                    {$i18n->_('From')}: <input type="text" name="activity_start_date" id="activity_start_date" value="{$post['activity_start_date']}" class="datetimepicker span4" />
                    {$i18n->_('To')}: <input type="text" name="activity_end_date" id="activity_end_date" value="{$post['activity_end_date']}" class="datetimepicker span4" />
                </td>
            </tr>
        </tbody>
    </table>
