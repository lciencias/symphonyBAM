	...
	<form id="savecategory" enctype="application/x-www-form-urlencoded"
		...
		<fieldset>
			...
			<div class="clearfix">
				...
				<span class="input">
					{html_options options=$serviceLevels name="id_service_level" id="id_service_level" selected=$category['id_service_level'] class="span4 required"}
                        ...
                        {if $category['id_ticket_type']==4 || $category['id_ticket_type']==3 || $idTicketType==4 || $idTicketType==3}
			...
			<table>
				<tr>
					<td style="width: 135px;  text-align: right; margin-right: 30px;">
						<label for="note" class="">{$i18n->_('Productos')}</label>
					</td>
					<td style="padding-top : 0">
						<table class="table">
							<tr>
			...
			<div class="actions">
				...
				<input name="send" id="send" value="{$i18n->_('Save')}" class="btn primary validaSend"
					type="submit">
